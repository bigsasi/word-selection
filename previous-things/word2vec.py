...
class Word2Vec(BaseEstimator, TransformerMixin):
    def __init__(self, batch_size=128, num_skips=2, skip_window=1,
                 ...
                 valid_size=16, valid_window=100, save_path='models/words_model'):
        ...
        self.final_embeddings = None # fit() will fill them
    ...
    def fit(self, words, continue_training=False):
        """
    ...
    def save(self, path):
        ...
        json.dump(params,
                  open(os.path.join(path, 'model_params.json'), 'w', encoding='utf8'))
